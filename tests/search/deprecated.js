...
exports['test search "two" from "one"'] = function(expect, complete) {
  var actual = search('two', packages(), addonPath('one'));
  expect(actual).to.be(
...
exports['test search "main" from "one"'] = function(expect, complete) {
  var actual = search('main', packages(), addonPath('one'));
  expect(actual).to.be(
...
exports['test search "panel" from "one"'] = function(expect, complete) {
  var actual = search('panel', packages(), addonPath('one'));
  expect(actual).to.be(
...
exports['test search "promise" from "one"'] = function(expect, complete) {
  var actual = search('promise', packages(), addonPath('one'));
  expect(actual).to.be(
...
exports['test search "two/core" from "one"'] = function(expect, complete) {
  var actual = search('two/core', packages(), addonPath('one'));
  expect(actual).to.be(
